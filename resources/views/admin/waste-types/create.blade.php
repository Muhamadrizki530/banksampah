...
<div class="waste-wrapper">
    ...
    <div class="waste-header">
        ...
        <div class="header-title">
            <h3>♻️ Tambah Jenis Sampah</h3>
            <p>Tambahkan kategori sampah baru beserta poin per kilogramnya.</p>
        </div>
        ...
        <form action="{{ route('admin.waste-types.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select
                    ...
                    <option value="Logam" {{ old('category') == 'Logam' ? 'selected' : '' }}>Logam</option>
                    <option value="Kaca" {{ old('category') == 'Kaca' ? 'selected' : '' }}>Kaca</option>
                    <option value="Tekstil" {{ old('category') == 'Tekstil' ? 'selected' : '' }}>Tekstil</option>
                    ...
                    <option value="Minyak Jelantah" {{ old('category') == 'Minyak Jelantah' ? 'selected' : '' }}>Minyak Jelantah</option>
