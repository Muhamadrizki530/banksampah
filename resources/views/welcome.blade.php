    ...
    <div class="wrap">
      ...
      <div class="steps">
        <div class="step">
          ...
          <p>Pisahkan sampah anorganik seperti plastik, kertas, dan logam dari sampah organik.</p><span class="step-arrow">→</span>
        </div>
        <div class="step">
          <div class="idx">02</div>
          <h3>Setor ke Titik Terdekat</h3>
          <p>Bawa ke titik setor sesuai jadwal mingguan di kelurahanmu.</p><span class="step-arrow">→</span>
        </div>
        <div class="step">
          <div class="idx">03</div>
          <h3>Ditimbang &amp; Dapat Poin</h3>
          <p>Petugas menimbang per kategori dan poinnya langsung masuk ke buku tabungan.</p><span class="step-arrow">→</span>
        </div>
        <div class="step">
          <div class="idx">04</div>
          <h3>Tukar ke Hadiah</h3>
          <p>Pakai poin kapan saja untuk voucher, sembako, atau kebutuhan lainnya.</p>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="passbook-wrap">
        ...
        <div class="harga-list">
          <div class="harga-item">
            <div class="name">Plastik PET<small>Botol minuman bening</small></div>
            <div class="price">20 poin / kg</div>
          </div>
          <div class="harga-item">
            <div class="name">Kertas &amp; Kardus<small>Koran, HVS, kardus bersih</small></div>
            <div class="price">10 poin / kg</div>
          </div>
          <div class="harga-item">
            <div class="name">Kaleng Aluminium<small>Kaleng minuman</small></div>
            <div class="price">100 poin / kg</div>
          </div>
          <div class="harga-item">
            <div class="name">Botol Kaca<small>Botol &amp; pecahan kaca bersih</small></div>
            <div class="price">5 poin / kg</div>
          </div>
          <div class="harga-item">
            <div class="name">Plastik Keras<small>Ember &amp; wadah plastik lain</small></div>
            <div class="price">15 poin / kg</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="testi-grid">
        <div class="testi">
          ...
          <div class="who">
            ...
            <div>
              <div class="name">Rina S.</div>
              <div class="role">Nasabah sejak 2023</div>
            </div>
          </div>
        </div>
        <div class="testi">
          ...
          <div class="who">
            ...
            <div>
              <div class="name">Ahmad H.</div>
              <div class="role">Nasabah RW 04</div>
            </div>
          </div>
        </div>
        <div class="testi">
          ...
          <div class="who">
            ...
            <div>
              <div class="name">Dewi P.</div>
              <div class="role">Nasabah RW 07</div>
            </div>
          </div>
        </div>
      </div>
